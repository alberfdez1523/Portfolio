...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="bg-gray-900 border-t border-gray-800 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-1 flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0">
          <span className="text-2xl font-bold text-blue-500">Alberto Fernández</span>
        </div>
        <div className="text-gray-400 text-center md:text-left">
          <p>&copy; {new Date().getFullYear()} Alberto Fernández.</p>
          <p className="mt-1">Hecho con <span className="text-red-500">❤</span> y ☕ usando Astro, </p>
