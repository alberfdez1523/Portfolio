...
export default function Experience({ lang = 'es' }: ExperienceProps) {
  ...
  return (
    <section id="experience" ref={containerRef} className="py-20 bg-white dark:bg-gray-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative border-l border-gray-200 dark:border-gray-700 ml-3 md:ml-6 space-y-12">
          {t.items.map((exp, index) => (
            ...
            >
              <span className="absolute flex items-center justify-center w-8 h-8 bg-blue-600 rounded-full -left-[2.2rem] md:-left-[3.2rem] ring-4 ring-white dark:ring-gray-800">
                <Briefcase size={16} className="text-white" />
              </span>
              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 hover:border-blue-500/30 transition-colors hover:transform hover:-translate-y-1 duration-300">
                <h3 className="flex items-center mb-1 text-xl font-semibold text-gray-900 dark:text-white">
                  {exp.title}
                </h3>
                <div className="flex flex-col md:flex-row md:items-center mb-4 text-gray-500 dark:text-gray-400 text-sm">
